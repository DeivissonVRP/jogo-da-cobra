...
try:
    pygame.mixer.music.load("sons/musica_fundo.mp3")  # carrega o arquivo de música
...
class Jogador:
    def __init__(self):
        ...
        self.y = ALTURA - 80
        self.velocidade = 7     # pixels que a nave anda por quadro
    ...
    def desenhar(self, tela):
        ...
        pygame.draw.polygon(tela, AZUL, [ponta, base_esq, base_dir])
